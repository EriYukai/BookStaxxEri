...
function createCustomButton(options) {
    ...
    try {
        ...
        if (customIcon) {
            ...
            // 타입에 따라 아이콘 내용 설정
            if (type === 'back') {
                iconElement.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36" fill="#4285f4"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>';
            } else if (type === 'add') {
                iconElement.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36" fill="#007AFF"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>';
            }
...
function showLoadingIndicator(container) {
    ...
    loader.innerHTML = `
        <div class="bookstaxx-spinner"></div>
        <div class="bookstaxx-loading-text">${loadingText}</div>
    `;
